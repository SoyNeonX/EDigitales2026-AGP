...
void loop() {
  ...
  tank4_level = map(analogRead(A3), 0, 1023, 100, 0);
...
if (tank4_level <= 73 && tank1_shutdown) {
  digitalWrite(11, HIGH);
} else if (tank4_level == 100 || !tank1_shutdown) {
  digitalWrite(11, LOW);
};
...
Serial.print("T4: ");Serial.print(tank4_level);Serial.print("%  ");
...
Serial.print("Blq: ");Serial.print(tank4_shutdown);Serial.println("  ");
}
